...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        #if UNITY_ANDROID
            string appId = "ca-app-pub-5969506551281405~4571632849";
        #elif UNITY_IPHONE
            string appId = "none";
        #else
  ...
  //      this.CreateAndLoadRewardedAd();
        ...
        // MonoBehaviour.print("START SHOW");
    ...
    private AdRequest CreateAdRequest()
    {
        return new AdRequest.Builder()
            ...
            //.SetBirthday(new DateTime(1985, 12, 1))
    ...
    private void RequestBanner()
    {
     ...
     //       string adUnitId = "ca-app-pub-3940256099942544/6300978111";
           string adUnitId = "ca-app-pub-5969506551281405/6286726119";
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-5969506551281405/8332103825";
#elif UNITY_IPHONE
 ...
 //       string adUnitId = "ca-app-pub-5969506551281405/6536586670";
